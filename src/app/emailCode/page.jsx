                    ...
                    <div className=' bg-white p-4  m-auto align-center'>
                        ...
                        <div>
                            <div className='m-auto justify-center align-center w-full pb-[2rem]'>
                                ...
                                <p className='text-black'>Enter the code that was sent to you</p>
                            </div>
                            <div className='pt-[1rem] pb-[3rem] flex justify-between m-auto w-1/2 gap-2'>
                            ...
                            <div className='w-1/2 justify-center m-auto'>
                                <CustomButton>Verify Code</CustomButton>
                            </div>
                        </div>
                    </div>
                </div>
